...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, AppCardComponent, AppButtonComponent, AppInputComponent, AppPaginationComponent, AppDropdownComponent, VehicleDetailsModalComponent, AppDataTableComponent],
...
export class VehicleDashboard {
  ...
  filteredVehicles = computed(() => {
    ...
    return vehicles.filter(v => 
      ...
      v.officerName?.toLowerCase().includes(search) ||
